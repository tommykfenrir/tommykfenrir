...
Founder/Admin of **Fenrir Security Systems**

I build security tools, automation scripts, and terminal-first projects.
Focused on Linux internals, offensive security fundamentals, and low-level computing.
...
- Gemini CLI + Gemini API (grounding & automation)
- Dislocker (BitLocker recovery workflows)
- Tailscale / Tailnet based remote infrastructure
...
Experience gained:
- Team coordination (5 members) and task distribution
- Repo moderation, testing workflows, and project SOP management
- Server environment setup and SSH-based collaboration
- Basic SOC-style monitoring and login alert automation (msmtp)
- Infrastructure management using Tailnet
